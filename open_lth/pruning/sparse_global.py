...
class Strategy(base.Strategy):
    ...
    def prune(pruning_hparams: PruningHparams, trained_model: models.base.Model, current_mask: Mask = None):
        ...
        print("Number of remaining weights before pruning: ")
        print(number_of_remaining_weights)
        print("Number of remaining weights after pruning: ")
        print(number_of_remaining_weights-number_of_weights_to_prune)
