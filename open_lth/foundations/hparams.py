...
class DatasetHparams(Hparams):
    ...
    #For the graph_dataset
    root: str = "/graph_dataset/."
    num_graphs: int = 10
    num_nodes: int = 10
    k: int = 2
    num_class: int = 2
    ...
    _dataset_name: str = 'The name of the dataset. Examples: mnist, cifar10, graph'
    ...
    #For the graph_dataset
    _root: str = "The directory in which to place the graph dataset"
    _num_graphs: str = "Number of generated graphs"
    _num_nodes: str = "Number of nodes per graph"
    _k: str = "K-regular graphs"
    _num_class: str = "Number of classes"
    _num_colors: str = "Number of colors of the graph"
    _dist: str = "Dist in the task"
...
class ModelHparams(Hparams):
    ...
    _model_name: str = 'The name of the model. Examples: mnist_lenet, cifar_resnet_20, cifar_vgg_16, gcn_1_20_10'
    ...
    _loss_criterion: str = 'Loss Criterion'
